...
public final class Code128Writer extends OneDimensionalCodeWriter {
  ...
  public boolean[] encode(String contents) {
    ...
    while (position < length) {
      ...
      // Get the pattern
      patterns.add(cn.vip.dw.bluetoothprinterlib.zxing.oned.Code128Reader.CODE_PATTERNS[patternIndex]);
    ...
    checkSum %= 103;
    patterns.add(cn.vip.dw.bluetoothprinterlib.zxing.oned.Code128Reader.CODE_PATTERNS[checkSum]);
