...
import cn.vip.dw.bluetoothprinterlib.zxing.client.result.EmailAddressParsedResult;
...
public final class EmailAddressResultParser extends ResultParser {
  ...
  @Override
  public cn.vip.dw.bluetoothprinterlib.zxing.client.result.EmailAddressParsedResult parse(Result result) {
    ...
    if (rawText.startsWith("mailto:") || rawText.startsWith("MAILTO:")) {
      ...
      return new cn.vip.dw.bluetoothprinterlib.zxing.client.result.EmailAddressParsedResult(tos, ccs, bccs, subject, body);
    } else {
