...
import cn.vip.dw.bluetoothprinterlib.zxing.oned.UPCEANExtension2Support;
...
/**
 * @see cn.vip.dw.bluetoothprinterlib.zxing.oned.UPCEANExtension2Support
 */
final class UPCEANExtension5Support {
  ...
  int decodeMiddle(BitArray row, int[] startRange, StringBuilder resultString) throws NotFoundException {
    ...
    for (int x = 0; x < 5 && rowOffset < end; x++) {
      int bestMatch = cn.vip.dw.bluetoothprinterlib.zxing.oned.UPCEANReader.decodeDigit(row, counters, rowOffset, UPCEANReader.L_AND_G_PATTERNS);
