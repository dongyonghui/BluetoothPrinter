...
package cn.vip.dw.bluetoothprinterlib.zxing.pdf417.encoder;
...
import cn.vip.dw.bluetoothprinterlib.zxing.pdf417.encoder.Compaction;
...
final class PDF417HighLevelEncoder {
   ...
   */
  static String encodeHighLevel(String msg, cn.vip.dw.bluetoothprinterlib.zxing.pdf417.encoder.Compaction compaction, Charset encoding) throws WriterException {
    ...
    if (compaction == cn.vip.dw.bluetoothprinterlib.zxing.pdf417.encoder.Compaction.TEXT) {
      encodeText(msg, p, len, sb, textSubMode);

    } else if (compaction == cn.vip.dw.bluetoothprinterlib.zxing.pdf417.encoder.Compaction.BYTE) {
