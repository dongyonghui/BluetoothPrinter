...
public final class Result {
  ...
  private final cn.vip.dw.bluetoothprinterlib.zxing.BarcodeFormat format;
  ...
  /**
   * @return {@link cn.vip.dw.bluetoothprinterlib.zxing.BarcodeFormat} representing the format of the barcode that was decoded
   */
