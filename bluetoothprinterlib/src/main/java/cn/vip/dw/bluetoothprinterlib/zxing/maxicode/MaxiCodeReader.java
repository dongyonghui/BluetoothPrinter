...
package cn.vip.dw.bluetoothprinterlib.zxing.maxicode;
...
import cn.vip.dw.bluetoothprinterlib.zxing.maxicode.decoder.Decoder;
...
public final class MaxiCodeReader implements Reader {
   ...
   * case.
   *
   * @see cn.vip.dw.bluetoothprinterlib.zxing.datamatrix.DataMatrixReader#extractPureBits(BitMatrix)
   * @see cn.vip.dw.bluetoothprinterlib.zxing.qrcode.QRCodeReader#extractPureBits(BitMatrix)
   */
