...
final class DetectionResult {
  ...
  private final cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.BarcodeMetadata barcodeMetadata;
  private final DetectionResultColumn[] detectionResultColumns;
  private cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.BoundingBox boundingBox;
  private final int barcodeColumnCount;

  DetectionResult(cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.BarcodeMetadata barcodeMetadata, cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.BoundingBox boundingBox) {
  ...
  private int adjustRowNumbers() {
    ...
    for (int barcodeColumn = 1; barcodeColumn < barcodeColumnCount + 1; barcodeColumn++) {
      cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword[] codewords = detectionResultColumns[barcodeColumn].getCodewords();
  ...
  private void adjustRowNumbersFromBothRI() {
    ...
    cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword[] LRIcodewords = detectionResultColumns[0].getCodewords();
    cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword[] RRIcodewords = detectionResultColumns[barcodeColumnCount + 1].getCodewords();
    for (int codewordsRow = 0; codewordsRow < LRIcodewords.length; codewordsRow++) {
      if (LRIcodewords[codewordsRow] != null &&
        ...
        for (int barcodeColumn = 1; barcodeColumn <= barcodeColumnCount; barcodeColumn++) {
          cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword codeword = detectionResultColumns[barcodeColumn].getCodewords()[codewordsRow];
          if (codeword == null) {
            continue;
          }
  ...
  private int adjustRowNumbersFromRRI() {
    ...
    cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword[] codewords = detectionResultColumns[barcodeColumnCount + 1].getCodewords();
    for (int codewordsRow = 0; codewordsRow < codewords.length; codewordsRow++) {
      if (codewords[codewordsRow] == null) {
        continue;
      }
  ...
  private int adjustRowNumbersFromLRI() {
    ...
    int unadjustedCount = 0;
    cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword[] codewords = detectionResultColumns[0].getCodewords();
    for (int codewordsRow = 0; codewordsRow < codewords.length; codewordsRow++) {
      if (codewords[codewordsRow] == null) {
        continue;
      }
  ...
  private static int adjustRowNumberIfValid(int rowIndicatorRowNumber, int invalidRowCounts, cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword codeword) {
    if (codeword == null) {
  ...
  private void adjustRowNumbers(int barcodeColumn, int codewordsRow, cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword[] codewords) {
    cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword codeword = codewords[codewordsRow];
    cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword[] previousColumnCodewords = detectionResultColumns[barcodeColumn - 1].getCodewords();
    cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword[] nextColumnCodewords = previousColumnCodewords;
    if (detectionResultColumns[barcodeColumn + 1] != null) {
      nextColumnCodewords = detectionResultColumns[barcodeColumn + 1].getCodewords();
    }

    cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword[] otherCodewords = new cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword[14];
    ...
    for (cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword otherCodeword : otherCodewords) {
   ...
   */
  private static boolean adjustRowNumber(cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword codeword, cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.Codeword otherCodeword) {
  ...
  public void setBoundingBox(cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.BoundingBox boundingBox) {
    this.boundingBox = boundingBox;
  }

  cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.BoundingBox getBoundingBox() {
    return boundingBox;
  }
