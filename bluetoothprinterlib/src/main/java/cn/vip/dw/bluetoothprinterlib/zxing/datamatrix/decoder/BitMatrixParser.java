...
final class BitMatrixParser {
  ...
  private final cn.vip.dw.bluetoothprinterlib.zxing.datamatrix.decoder.Version version;
  ...
  cn.vip.dw.bluetoothprinterlib.zxing.datamatrix.decoder.Version getVersion() {
    return version;
  }
   ...
   * @return {@link cn.vip.dw.bluetoothprinterlib.zxing.datamatrix.decoder.Version} encapsulating the Data Matrix Code's "version"
   * @throws FormatException if the dimensions of the mapping matrix are not valid
   * Data Matrix dimensions.
   */
  private static cn.vip.dw.bluetoothprinterlib.zxing.datamatrix.decoder.Version readVersion(BitMatrix bitMatrix) throws FormatException {
