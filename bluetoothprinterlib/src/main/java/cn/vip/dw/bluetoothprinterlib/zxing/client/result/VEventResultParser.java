...
import cn.vip.dw.bluetoothprinterlib.zxing.client.result.CalendarParsedResult;
...
public final class VEventResultParser extends ResultParser {
  ...
  private static String matchSingleVCardPrefixedField(CharSequence prefix,
                                                      String rawText,
                                                      boolean trim) {
    List<String> values = cn.vip.dw.bluetoothprinterlib.zxing.client.result.VCardResultParser.matchSingleVCardPrefixedField(prefix, rawText, trim, false);
