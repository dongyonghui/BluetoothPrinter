...
package cn.vip.dw.bluetoothprinterlib.zxing.pdf417;
...
import cn.vip.dw.bluetoothprinterlib.zxing.ResultMetadataType;
import cn.vip.dw.bluetoothprinterlib.zxing.ResultPoint;
import cn.vip.dw.bluetoothprinterlib.zxing.common.DecoderResult;
import cn.vip.dw.bluetoothprinterlib.zxing.multi.MultipleBarcodeReader;
import cn.vip.dw.bluetoothprinterlib.zxing.pdf417.PDF417Common;
import cn.vip.dw.bluetoothprinterlib.zxing.pdf417.PDF417ResultMetadata;
import cn.vip.dw.bluetoothprinterlib.zxing.pdf417.decoder.PDF417ScanningDecoder;
import cn.vip.dw.bluetoothprinterlib.zxing.pdf417.detector.Detector;
import cn.vip.dw.bluetoothprinterlib.zxing.pdf417.detector.PDF417DetectorResult;
...
public final class PDF417Reader implements Reader, MultipleBarcodeReader {
  ...
  private static int getMaxCodewordWidth(ResultPoint[] p) {
    return Math.max(
        Math.max(getMaxWidth(p[0], p[4]), getMaxWidth(p[6], p[2]) * cn.vip.dw.bluetoothprinterlib.zxing.pdf417.PDF417Common.MODULES_IN_CODEWORD /
            cn.vip.dw.bluetoothprinterlib.zxing.pdf417.PDF417Common.MODULES_IN_STOP_PATTERN),
        Math.max(getMaxWidth(p[1], p[5]), getMaxWidth(p[7], p[3]) * cn.vip.dw.bluetoothprinterlib.zxing.pdf417.PDF417Common.MODULES_IN_CODEWORD /
            cn.vip.dw.bluetoothprinterlib.zxing.pdf417.PDF417Common.MODULES_IN_STOP_PATTERN));
  }

  private static int getMinCodewordWidth(ResultPoint[] p) {
    return Math.min(
        Math.min(getMinWidth(p[0], p[4]), getMinWidth(p[6], p[2]) * cn.vip.dw.bluetoothprinterlib.zxing.pdf417.PDF417Common.MODULES_IN_CODEWORD /
            cn.vip.dw.bluetoothprinterlib.zxing.pdf417.PDF417Common.MODULES_IN_STOP_PATTERN),
        Math.min(getMinWidth(p[1], p[5]), getMinWidth(p[7], p[3]) * cn.vip.dw.bluetoothprinterlib.zxing.pdf417.PDF417Common.MODULES_IN_CODEWORD /
