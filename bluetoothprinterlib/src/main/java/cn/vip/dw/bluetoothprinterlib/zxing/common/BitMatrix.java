...
package cn.vip.dw.bluetoothprinterlib.zxing.common;
...
public final class BitMatrix implements Cloneable {
  ...
  public void xor(BitMatrix mask) {
    ...
    cn.vip.dw.bluetoothprinterlib.zxing.common.BitArray rowArray = new cn.vip.dw.bluetoothprinterlib.zxing.common.BitArray(width / 32 + 1);
   ...
   *         your own row
   */
  public cn.vip.dw.bluetoothprinterlib.zxing.common.BitArray getRow(int y, cn.vip.dw.bluetoothprinterlib.zxing.common.BitArray row) {
    if (row == null || row.getSize() < width) {
      row = new cn.vip.dw.bluetoothprinterlib.zxing.common.BitArray(width);
    } else {
      row.clear();
    }
    int offset = y * rowSize;
  ...
  /**
   * @param y row to set
   * @param row {@link cn.vip.dw.bluetoothprinterlib.zxing.common.BitArray} to copy from
   */
  public void setRow(int y, cn.vip.dw.bluetoothprinterlib.zxing.common.BitArray row) {
  ...
  public void rotate180() {
    ...
    cn.vip.dw.bluetoothprinterlib.zxing.common.BitArray topRow = new cn.vip.dw.bluetoothprinterlib.zxing.common.BitArray(width);
    cn.vip.dw.bluetoothprinterlib.zxing.common.BitArray bottomRow = new BitArray(width);
