...
import cn.vip.dw.bluetoothprinterlib.zxing.pdf417.encoder.BarcodeRow;
...
public final class BarcodeMatrix {
  ...
  private final cn.vip.dw.bluetoothprinterlib.zxing.pdf417.encoder.BarcodeRow[] matrix;
  ...
  BarcodeMatrix(int height, int width) {
    matrix = new cn.vip.dw.bluetoothprinterlib.zxing.pdf417.encoder.BarcodeRow[height];
    //Initializes the array to the correct width
    for (int i = 0, matrixLength = matrix.length; i < matrixLength; i++) {
      matrix[i] = new cn.vip.dw.bluetoothprinterlib.zxing.pdf417.encoder.BarcodeRow((width + 4) * 17 + 1);
    }
    this.width = width * 17;
    this.height = height;
    this.currentRow = -1;
  ...
  cn.vip.dw.bluetoothprinterlib.zxing.pdf417.encoder.BarcodeRow getCurrentRow() {
